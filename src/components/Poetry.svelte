...
<section class="grid min-h-[50vh] py-12 lg:py-28 lg:px-24 px-4 lg:grid-cols-8 gap-8 justify-end items-start">
    <div class="col-span-3  h-full">
        <h2 class="text-7xl font-cormorant  font-black italic leading-10 tracking-tight text-center text-[color:var(--color-text)] md:text-center sm:leading-none md:text-6xl lg:text-[10rem]">Poetry</h2>
    </div>

...
<!-- Section 1 -->
<section class="flex items-center border-2  border-[color:var(--color-text)] justify-center max-w-7xl mx-auto ">
    <div class="px-16 py-24">
        <div class="container flex flex-col items-start mx-auto lg:items-center">
            <h2 class="relative flex items-start justify-start w-full max-w-3xl text-9xl font-cormorant italic text-[color:var(--color-text)] font-bold lg:justify-center">
